	...
	<div class='Table_Data_Rich_Web_VS_Content' >
		...
		<div class='Table_Data_VS_Rich_Web2' >
			...
			<table class='Rich_Web_Save_VSlider_Table' style='float:left;'>
				...
				<tr>
					<td class='Rich_Web_VSlider_Add_Vid' colspan='3'>
						Add Video
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan='2'>
						<textarea type='text' class='Rich_Web_VSlider_Input Rich_Web_VSlider_Input2 Rich_Web_VSlider_Desc' id='Rich_Web_VSlider_Desc' style='height:80px;'>
			...
			<table class='Rich_Web_Save_VSlider_Table3' onmousemove='Rich_Web_VSlider_Sortable()'>
