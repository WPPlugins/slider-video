<?php
	...
	*/
	...
	function Rich_Web_Video_Slider_Style(){
		...
		wp_register_script('Rich_Web_Video_Slider2',plugins_url('/Scripts/responsiveCarousel.min.js',__FILE__));
	...
	{
		$complete_url = wp_nonce_url( $bare_url, 'edit-menu_'.$comment_id, 'Rich_Web_VSlider_Nonce' );
